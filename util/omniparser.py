...
class Omniparser(object):
    def __init__(self, config: Dict):
        ...
        self.caption_model_processor = get_caption_model_processor(model_name=config['caption_model_name'],
    ...
    def parse(self, image_base64: str):
        ...
        (text, ocr_bbox) = check_ocr_box(image, display_img=False, output_bb_format='xyxy',
